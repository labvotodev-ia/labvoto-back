...
# ==================== CUSTO POR VOTO (BigQuery) ====================

@app.get(
    "/api/v1/custo-por-voto",
    response_model=schemas.CustoPorVotoResponse,
    tags=["Partidos"],
)
def buscar_custo_por_voto(
    anos: str,
    cargos: str,
    siglas_uf: str,
    sigla_partido: str,
    ...
    """
    Executa a query de custo por voto para eleitos, com parâmetros via URL.
    ...
    Exemplo:
    - /api/v1/custo-por-voto?anos=2022&cargos=deputado%20federal&siglas_uf=SP&sigla_partido=PODE
    """
    ...
    try:
        resultados = bigquery_client.buscar_custo_por_voto_eleitos(
            anos=anos_list,
            cargos=cargos_list,
